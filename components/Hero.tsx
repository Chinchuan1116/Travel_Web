...
const Hero = () => {
  return (
    <section className='max-container padding-container flex flex-col gap-23 py-10 pb-32 md:gap-28 lg"py-20 xl:flex row'>
        ...
        <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
            ...
            <div className='flex flex-col w-full gap-3 sm:flex-row'>
                ...
                <Button type='button' title='How do we work?' icon='/play.svg' variant='btn_white_text'/>
            </div>
        </div>
